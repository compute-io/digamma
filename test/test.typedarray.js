...
var // Expectation library:
	...
	// Module to be tested:
	digamma = require( './../lib/typedarray.js' );
...
describe( 'typed-array digamma', function tests() {
	...
	it( 'should evaluate the quantile function of the Logistic distribution', function test() {
		var data, actual, expected, i;

		data = new Float64Array( validationData.data );
		actual = new Float64Array( data.length );

		actual = digamma( actual, data );
	...
	it( 'should return an empty array if provided an empty array', function test() {
		assert.deepEqual( digamma( new Int8Array(), new Int8Array() ), new Int8Array() );
	});
